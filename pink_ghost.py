...
class Pink_Ghost:
    def __init__(self, x, y, target_x, target_y):
        ...
        self.speed = 1
        self.moving = False
        self.image = pink_shadow_right_1
        self.direction = "UP"
    ...
    def draw(self, screen):
        ...
        if self.vulnerable:
            ...
            if elapsed_time > 100:
                if self.direction == "RIGHT":
                    if self.image == pink_shadow_right_1:
                        self.image = pink_shadow_right_2
                    else:
                        self.image = pink_shadow_right_1
                    self.last_image_change_time = current_time
                if self.direction == "LEFT":
                    if self.image == pink_shadow_left_1:
                        self.image = pink_shadow_left_2
                    else:
                        self.image = pink_shadow_left_1
                    self.last_image_change_time = current_time
                if self.direction == "UP":
                    if self.image == pink_shadow_up_1:
                        self.image = pink_shadow_up_2
                    else:
                        self.image = pink_shadow_up_1
                    self.last_image_change_time = current_time
                if self.direction == "DOWN":
                    if self.image == pink_shadow_down_1:
                        self.image = pink_shadow_down_2
                    else:
                        self.image = pink_shadow_down_1
                    self.last_image_change_time = current_time
